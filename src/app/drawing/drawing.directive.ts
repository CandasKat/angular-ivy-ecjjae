...
export class DrawingDirective implements OnInit {
  public c;
  public output;
  public ctx;
  public draw = false;
  ...
  ngOnInit() {
    this.c  = this.el.nativeElement.querySelector('canvas');
    this.output = this.el.nativeElement.querySelector('output');
    if(this.c){
